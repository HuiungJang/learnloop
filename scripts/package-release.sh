...
cp scripts/local-ai-before-snapshot-cache.mjs "$STAGING_DIR/local-ai-before-snapshot-cache.mjs"
...
cp scripts/local-ai-companion-launcher.mjs "$STAGING_DIR/local-ai-companion-launcher.mjs"
